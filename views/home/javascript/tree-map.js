...
(function(){
  var prelude, ref$, Obj, map, filter, each, find, fold, foldr, fold1, all, flatten, sum, groupBy, objToPairs, partition, join, unique, pow, sqrt, formatDate, hardClone, trace, sor, shortenWurflDeviceName, _sumStats, sumVisits, sumSubscribers, updateAllNodes, killChildrenByCriteria, killChildren, stats, exports;
