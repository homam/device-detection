...
(function(){
  var prelude, ref$, Obj, map, filter, each, find, fold, foldr, fold1, all, flatten, sum, groupBy, objToPairs, partition, join, unique, listOfSubscriptioMethods, formatDate, pow, pow2, sqrt, sor, hardClone, trace, treeUiTypes, treeChart, showDialog;
