...
(function(){
  var prelude, ref$, Obj, map, filter, each, find, fold, foldr, fold1, all, flatten, sum, groupBy, objToPairs, partition, join, unique, pow, sqrt, listOfSubscriptioMethods, hardClone, trace, sor, shortenWurflDeviceName, _sumStats, sumVisits, sumSubscribers, foldRealNodes, updateAllNodes, killChildren, stats, width, height, tree, diagonal, $svg, updateTree;
