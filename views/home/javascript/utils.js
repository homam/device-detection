...
(function(){
  var ref$, Obj, map, filter, each, find, fold, foldr, fold1, all, flatten, sum, groupBy, objToPairs, partition, join, unique, exports, eachTreeNode, trace, _sumStats, sumVisits, sumSubscribers, updateAllNodes, killChildrenByCriteria, killChildren, stats;
